        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    /*TermsOfService = new Uri("https://github.com/droppiorg/apiforumcivil"),
                    Contact = new OpenApiContact
                    {
                        Name = "Collaborators",
                        Url = new Uri("https://github.com/droppiorg/apiforumcivil"),
                    },
                    License = new OpenApiLicense
                    {
                        Name = "Licencse",
                        Url = new Uri("https://github.com/droppiorg")
                    }*/
                });
